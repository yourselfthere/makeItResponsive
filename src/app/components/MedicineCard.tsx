    ...
    <div className="font-sora ">
      ...
      <div className="w-[310px] h-[554px] rounded-[30px_0px_30px_0px] border-2 border-[#28E3E9] bg-white flex flex-col gap-3">
        <div className="h-[41px] flex items-end">
          <div className="ml-4 text-[#A10C0C] h-[21px] flex place-content-center gap-1 bg-[#A10C0C0D] w-[150px] p-[3px_12px_3px_12px] items-center rounded-[30px_30px_30px_30px]  ">
            <div className="w-1 h-1 bg-[#A10C0C] rounded-full"></div>
            <div className="font-light text-[12px]">nicht lieferbar</div>
          </div>
        </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-baseline text-[#365758] gap-2 ">
                  ...
                  <div className="text-[16px]">Mango</div>
                </div>
                <div className="flex items-baseline text-[#365758] gap-2 ">
